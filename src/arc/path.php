	...
	class path extends Pluggable {
		...
		*/
		...
		/**
			...
			@returns string|null The parent of the given path or null if the parent is outside the root path.
		*/
		...
		/**
			...
			@returns string A path with all filenames changed as by the callback method.
		*/
